...
public record ChatModel(@NotNull Long id, @NotNull String chatTitle, @NotNull Long timeOfCreation, @NotNull Long[] users, @NotNull Long[] chatHistory) implements EntityModel<Long>
{
