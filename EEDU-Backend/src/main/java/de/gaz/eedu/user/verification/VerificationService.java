...
@Service public class VerificationService
{
    ...
    {
        return user.getCredentials().stream().filter(CredentialEntity::isEnabled).map(CredentialEntity::getMethod)
     ...
     */
    public @NotNull String credentialToken(long userID,
            @NotNull Instant expiry, boolean advanced, @NotNull CredentialMethod @NotNull ... credentialMethod)
    {
