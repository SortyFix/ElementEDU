...
public class PrivilegeController extends EntityController<PrivilegeService, PrivilegeModel, PrivilegeCreateModel>
{
     ...
     */
    @PreAuthorize("hasAnyAuthority(${privilege.privilege.create})") @PostMapping("/create")
    @Override
     ...
     */
    @PreAuthorize("hasAnyAuthority(${privilege.privilege.delete})")
     ...
     */
    @PreAuthorize("hasAnyAuthority(${privilege.privilege.get})") @GetMapping("/get/{id}")
     ...
     *                   Must not be null.
     */
    @PreAuthorize("hasAnyAuthority(${privilege.group.privilege.grant})")
     ...
     *                   Must not be null.
     */
    @PreAuthorize("hasAnyAuthority(${privilege.group.privilege.revoke})")
