...
public record InternalFrequentAppointmentCreateModel(long courseId,
                                                     FrequentAppointmentCreateModel data) implements CreationModel<Long, FrequentAppointmentEntity>
{
