...
public class AppointmentEntryEntity implements EntityModelRelation<Long, AppointmentEntryModel>
{
    ...
    public boolean setRoom(@NotNull AppointmentService service, @NotNull RoomEntity room)
    {
        if(this.setRoom(room))
        {
            service.getEntryRepository().save(this);
        }
        return false;
    }

    public boolean setRoom(@NotNull RoomEntity room)
    {
        if(Objects.equals(room, getRoom().orElse(null)))
        {
            return false;
        }
        this.room = room;
    ...
    public boolean unsetRoom(@NotNull AppointmentService service)
    {
        if(unsetRoom())
        {
            service.getEntryRepository().save(this);
    ...
    public boolean setDescription(@NotNull AppointmentService service, @NotNull String description)
    {
    ...
    public boolean unsetDescription(@NotNull AppointmentService service)
    {
        if(this.unsetDescription())
        {
            service.getEntryRepository().save(this);
            return true;
        }
    ...
    public boolean unsetAssignment(@NotNull AppointmentService service)
    {
        if(this.unsetAssignment())
        {
            service.getEntryRepository().save(this);
            return true;
        }
