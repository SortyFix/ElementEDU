...
export class FileService {
    ...
    // ------------------------------ DOWNLOAD -----------------------------------
    public async fetchFile(id: bigint, identifier?: number | string,
                                url: string = (identifier == null ? `${(this.URL_PREFIX)}/get/${id}` : `${(this.URL_PREFIX)}/get/${id}/${identifier}`)): Promise<FileResponse> {
